  ...
  return (
    <footer className="w-full bg-gradient-to-r from-indigo-500 to-purple-500 text-white py-6 px-10 flex items-center justify-between shadow-lg">
      ...
      <div className="text-center">
        <p className="text-lg">
          Designed By <span className="font-semibold">Simran</span> @2024
        </p>
      ...
      <div className="text-center">
        ...
        <div className="flex items-center gap-3 mt-2">
          <a
            href="https://www.linkedin.com/in/simransahu313/"
            target="_blank"
          ...
          <a
            href="https://www.instagram.com/simran._sahu/"
            target="_blank"
            rel="noopener noreferrer"
            className="p-2 bg-white rounded-full shadow-md hover:scale-110 transition duration-300"
          >
          ...
          <a
            href="mailto:simsahu313@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
            className="p-2 bg-white rounded-full shadow-md hover:scale-110 transition duration-300"
          >
